...
<!-- ![Redundancy Example](../blog/images/RedundancyExample.png)
![Fault Tolerance Example](../blog/images/FaultTolerance.png) -->
...
- Think of sequential computing as items one at a time on a conveyor belt.
	...
	<!-- ![Sequential Computing](../blog/images/SequentialComputing.png) -->
...
- Example: 
    ...
    <!-- ![Parallel Computing](../blog/images/ParallelComputing.png) -->
...
- How is it different from sequential and parallel execution?
  ...
  <!-- ![Distributed Computing](../blog/images/DistributedComputing.png) -->
