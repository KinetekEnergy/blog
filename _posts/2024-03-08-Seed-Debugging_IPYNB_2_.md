...
* Collaboration
    ...
    * Discussion of features to add and features to add on
* Partial ideation:
    * How can we combine old ideas with new ones? Most of our group members are different from last trimester, so we have a lot of different ideas and projects to base our new one off of. We want to see the best way to incorporate several ideas into one.
